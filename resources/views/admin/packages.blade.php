...
@section('content')
	<div class="card">
	    <div class="card-header">
	        <h5>Package List</h5>
	        <button class="btn btn-sm btn-primary float-right add_package" data-toggle="modal" data-target="#PackageModal">Add New Pack</button>
	    </div>
	    <div class="card-body">
               ...
               <form id="PackageForm" method="post" action="{{route('add.package')}}" novalidate>
                <div class="modal-body">
                   <input type="hidden" name="id" id="package_id">
						...
						<div class="form-group row">
                            <label class="col-sm-3 col-form-label" for="title">Pack Type</label>
                            <div class="col-sm-9">
...
<script>
	$(function() {
		$('#PackageTable').DataTable({
            ...
            { title:'Pack Type', data: 'package_type'},
	...
	$(document).on('click','.packageEdit',function(){
		...
		let type = $(this).attr('package_type');
